...
<img src="https://render.githubusercontent.com/render/math?math=\mathbb{E}\!\left[\int_{0}^{T}e^{-rt}S_t^2\Gamma_{\mathrm{BS}}(t,S_t;\sigma_{BE})(\sigma_t^2-\sigma_{BE}^2)\,dt\right]=0">
